	...
	// 	];
			let steps = 
				...
				"As outlined by a cartogram approach, we consider each of these sub-indices and, ultimately, our overall Danger Index at the state-level.", 
				 ...
				 "For example, it can be observed that both Alaska (42%) and Washington D.C. (42%) provide the most reproductive health services to residents.",
				 "Contrastingly, Texas (94%) lacks the most in reproductive health services for residents.",
				 ...
				 "Here, we can see that women are subjected to the least amount of violent crime in the state of New York (2%).", 
