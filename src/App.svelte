<script>
	...
	let steps = ["As outlined by a cartogram approach, we consider each of these sub-indices and, ultimately, our overall danger 				Index at the state-level.", 
				 ...
				 "In our last example, we can see that Oregon (#) provides the most legal protections for residents.  Shockingly, residents of ID, UT, NE, MO, KY, DE, AR, NC, SC, LA, MS, AL, and FL do not have any legal protections.", 
