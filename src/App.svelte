<script>
	...
	let steps = ["As outlined by a cartogram approach, we consider each of these sub-indices and, ultimately, our overall danger 				Index at the state-level.", 
				 ...
				 "Below, we can see that women are subjected to the least amount of violent crime in the state of New York (2%).  In Arkansas (100%), however, women are subjected to the most amount of violent crime.", 
				 ...
				 "In our last example, we can see that Oregon (17%) provides the most legal protections for residents.  Shockingly, residents of ID, UT, NE, MO, KY, DE, AR, NC, SC, LA, MS, AL, and FL do not have any legal protections.", 
				 "In considering all of these sub-indices, we created our overall danger index.", 
				 "As illustrated below, Washington D.C (20%) scores the lowest on our overall danger index,  rendering it the safest place for female assigned at birth (AFAB) and femme folx to reside in.", 
