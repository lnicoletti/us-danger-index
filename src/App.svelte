	...
	// 	];
			let steps = 
				...
				"<div>As outlined by a cartogram approach, we consider each of these sub-indices and, ultimately, our <i>Overall Danger Index</i> at the state-level.</div>", 
				 ...
				 "<div>Our analysis illustrates that red states (i.e., states whose voters predominantly choose the Republican Party) are consistently more dangerous than blue states (i.e., states whose voters predominantly choose the Democratic Party) for female assigned at birth (AFAB) and femme folx.  In fact, our <span style='font-style:italic'>Overall Danger Index</span> indicates that, on average, red states are 80% more dangerous than blue states for these people.</div>",
